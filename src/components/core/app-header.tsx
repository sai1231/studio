...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-auto md:h-16 flex-col md:flex-row items-center gap-4 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-4 md:px-6 py-2 md:py-0">
      <div className="flex-1 w-full space-y-2">
        <div className="relative w-full flex items-center gap-2 rounded-lg bg-muted px-2.5 h-10">
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-1 -mt-1 w-full">
