...
import { subscribeToLogs, type LogEntry } from '@/services/loggingService';
        ...
        <div className="container mx-auto py-8">
            <Card className="shadow-lg h-[calc(100vh-10rem)] flex flex-col">
                <CardHeader>
                    ...
                    <CardDescription>
                        Real-time logs from server-side operations like content enrichment. New logs appear at the top.
                    </CardDescription>
                </CardHeader>
