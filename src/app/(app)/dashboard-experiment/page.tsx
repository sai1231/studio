...
const pageLoadingMessages = [
  "Organizing your experimental memories...",
  "Fetching your alternative inspirations...",
  "Aligning your new ideas...",
  "Connecting the experimental dots...",
];
  ...
  return (
    <div className="container mx-auto py-2">
      <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
        <h1 className="text-3xl font-headline font-semibold text-foreground">My Memories (Experiment)</h1>
